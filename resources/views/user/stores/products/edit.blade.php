        ...
        <form action="{{ route('user.stores.products.update', [$store->id, $product->id]) }}"
            ...
            <div class="mb-6">
                ...
                <textarea name="description" rows="4"
                          class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg px-4 py-2">{{ old('description', $product->description) }}</textarea>
            </div>
            ...
            <div class="mb-6">
                ...
                <img src="{{ $product->image ? asset('storage/' . $product->image) : asset('images/default-product.png') }}"
                     class="w-32 h-32 object-cover rounded-lg mt-3 border border-gray-700">
            </div>
